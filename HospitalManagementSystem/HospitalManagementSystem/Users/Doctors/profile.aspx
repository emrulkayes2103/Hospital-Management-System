<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/admins.Master" CodeBehind="profile.aspx.cs" Inherits="HospitalManagementSystem.Users.Doctors.profile" %>
            ...
            <fieldset id="Fieldset1" class="ProfileField">
                ...
                <legend style="margin-left:10%;color:#808080; font-family:Tahoma;font-size:25px;">Update Profile</legend>
                    ...
                    <table id="tblForm2" class="tblForm">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox TextMode="MultiLine" style="height:34px;width:300px; margin:2px 4px; font-family:Tahoma;font-size:16px;" ID="txtAddress" runat="server" placeholder="Enter your Address"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox style="height:34px;width:300px; margin:2px 4px; font-family:Tahoma;font-size:16px;" ID="txtDept" ReadOnly="true" runat="server" placeholder="Enter your Depertment"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
