...
namespace HospitalManagementSystem.Users.Accountent
{
    public partial class dashboard : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Users/Accountent/addPayement.aspx");
        }

        protected void bloodDonor_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Users/Accountent/paymentHistory.aspx");
        }

        protected void profile_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Users/Accountent/profile.aspx");
        }
