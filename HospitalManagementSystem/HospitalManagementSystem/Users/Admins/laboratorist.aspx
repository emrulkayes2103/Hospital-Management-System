<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/admins.Master" CodeBehind="laboratorist.aspx.cs" Inherits="HospitalManagementSystem.Users.Admins.pharmasist" %>
...
<asp:Content ID="contentForCenterBody" runat="server" ContentPlaceHolderID="centerbody">
    ...
    <div id="depertment" class="depertment">
        <h3>Laboratorist</h3>
        <input type="button" class="sbmitBtn" name="AddDepertment" value="Add laboratorist" onclick="showHide();" />
        <div id="addDept" class="addDept" style="position:relative;display:none; ">
            ...
            <table id="table1" class="table1">
                <tr>
                    <td>Name : </td>
                    <td>
            <asp:TextBox ID="txtLaboratoristName" runat="server" style="width:300px; height:30px;" ></asp:TextBox>
                        </td>
                    </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPass" runat="server" TextMode="Password" style="width:300px; height:30px;" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtRepass" runat="server" TextMode="Password" style="width:300px; height:30px;" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div id="detList" class="deptList">
            <asp:GridView ID="GridView1" AllowPaging="True" PageSize="5" style="table-layout:fixed;font-family:Tahoma;height:auto;width:100%; margin-top:15px;" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="Email" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit">
