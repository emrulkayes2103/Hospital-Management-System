<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/admins.Master" CodeBehind="doctors.aspx.cs" Inherits="HospitalManagementSystem.Users.Admins.doctors" %>
...
<asp:Content ID="contentForCenterBody" runat="server" ContentPlaceHolderID="centerbody">
    ...
    <div id="depertment" class="depertment">
        <h3>Doctor</h3>
        <input type="button" class="sbmitBtn" name="AddDepertment" value="Add Doctor" onclick="showHide();" />
        <div id="addDept" class="addDept" style="position:relative;display:none; ">
            ...
            <table id="table1" class="table1">
                <tr>
                    <td>Name : </td>
                    <td>
            <asp:TextBox ID="txtDoctName" runat="server" style="width:300px; height:30px;" ></asp:TextBox>
                ...
                <tr>
                    <td>Password : </td>
                    <td><asp:TextBox ID="txtPass" TextMode="Password" runat="server" style="width:300px; height:30px;"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Re-Type Password : </td>
                    <td><asp:TextBox ID="txtRepass" TextMode="Password" runat="server" style="width:300px; height:30px;"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        Address : 
                ...
                <tr>
                    <td>Depertment : </td>
                    <td>
                        <asp:DropDownList ID="dept" runat="server" style="width:305px; height:40px;"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <asp:GridView ID="GridView1" AllowPaging="True" PageSize="5" style="table-layout:fixed;font-family:Tahoma;height:auto;width:100%; margin-top:15px;" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Phone">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtPhn" style="height:34px;width:95%; margin:2px 4px; font-family:Tahoma;font-size:20px;" runat="server" Text='<%# Eval("Phone") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Depertment">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtDept" style="height:34px;width:95%; margin:2px 4px; font-family:Tahoma;font-size:20px;" runat="server" Text='<%# Eval("Depertment") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="txtDept" runat="server" Text='<%# Eval("Depertment") %>'></asp:Label>
                        </ItemTemplate>
                        <ControlStyle CssClass="gridViewcolumn" />
                    </asp:TemplateField>
