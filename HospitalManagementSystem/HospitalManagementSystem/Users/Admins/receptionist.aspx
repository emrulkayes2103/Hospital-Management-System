<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/admins.Master" CodeBehind="receptionist.aspx.cs" Inherits="HospitalManagementSystem.Users.Admins.receptionist" %>
...
<asp:Content ID="contentForCenterBody" runat="server" ContentPlaceHolderID="centerbody">
    ...
    <div id="depertment" class="depertment">
        <h3>Receptionist</h3>
        <input type="button" class="sbmitBtn" name="AddDepertment" value="Add Receptionist" onclick="showHide();" />
        <div id="addDept" class="addDept" style="position:relative;display:none; ">
            ...
            <table id="table1" class="table1">
                <tr>
                    <td>Name : </td>
                    <td>
            <asp:TextBox ID="txtReceptionistName" runat="server" style="width:300px; height:30px;" ></asp:TextBox>
                        </td>
                    </tr>
                <tr>
                    <td>
