<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/admins.Master" CodeBehind="profile.aspx.cs" Inherits="HospitalManagementSystem.Users.Receptionist.profile" %>
            ...
            <fieldset id="Fieldset1" class="ProfileField">
                ...
                <legend style="margin-left:10%;color:#808080; font-family:Tahoma;font-size:25px;">Update Profile</legend>
                    ...
                    <table id="tblForm2" class="tblForm">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox style="height:34px;width:300px; margin:2px 4px; font-family:Tahoma;font-size:16px; cursor:not-allowed;" ID="txtEmail" runat="server" ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
